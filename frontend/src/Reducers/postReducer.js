...
export const likeReducer = createReducer(initialState, {
    ...
    addCommentRequest: (state) => { state.loading = true },
    ...
    updateCaptionRequest: (state) => { state.loading = true },
    ...
    deleteProfileRequest: (state) => { state.loading = true },
    ...
    followUserRequest: (state) => { state.loading = true },
...
export const myPostReducers = createReducer(initialState, {
...
export const userPostReducers = createReducer(initialState, {
